...
\begin{alignat}{3}
  ...
  &\Leftrightarrow &\quad \tan(\alpha_{max}) &= \mu_{HR}
\end{alignat}
...
\Delta \mu_{\mathrm{HR}}&=\left|\frac{\partial \mu_{\mathrm{HR}}}{\partial \alpha_{\max }} \cdot \Delta \alpha_{\max }\right|=\left|\frac{1}{\cos ^{2}\left(\alpha_{\max }\right)} \cdot \Delta \alpha_{\max }\right|
\end{align}
